...
""",
    ...
    parser.add_argument(
        "--algorithm", "-a", choices=list(ALGORITHMS.keys()), help="Algorithm to train"
    )

    parser.add_argument(
        "--config", "-c", type=str, help="Path to configuration file (.json or .py)"
    )
    ...
    parser.add_argument(
        "--create-examples", action="store_true", help="Create example configuration files"
    )
