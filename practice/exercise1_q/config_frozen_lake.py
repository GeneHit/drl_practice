...
from practice.core.utils.env_utils import get_device, make_discrete_env_with_kwargs
...
def get_app_config() -> QTableConfig:
    ...
    return QTableConfig(
        ...
        learning_rate=0.7,
        gamma=0.95,
        epsilon_schedule=ExponentialSchedule(v0=1.0, v1=0.05, decay_rate=0.0005),
        eval_episodes=100,
        eval_random_seed=42,
        eval_video_num=10,
