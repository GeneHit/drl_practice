...
def _minimal_sac_config(temp_output_dir: Path) -> SACConfig:
    """Return a minimal SACConfig for fast testing."""
...
def test_sac_trainer_basic_flow(temp_output_dir: Path) -> None:
    """Test SACTrainer training flow with minimal config and no file saving."""
    config = _minimal_sac_config(temp_output_dir)
