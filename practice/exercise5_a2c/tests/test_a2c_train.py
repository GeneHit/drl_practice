...
def _minimal_a2c_config(temp_output_dir: Path) -> A2CConfig:
    """Return a minimal A2CConfig for fast testing."""
...
def test_a2c_trainer_basic_flow(temp_output_dir: Path) -> None:
    """Test A2CTrainer training flow with minimal config and no file saving."""
    config = _minimal_a2c_config(temp_output_dir)
