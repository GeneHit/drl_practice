...
from practice.core.utils.play_utils import _load_model_from_config, play_and_generate_video_generic
...
class TestPlayAndGenerateVideoGeneric:
    ...
    @patch("practice.core.utils.play_utils._play_game_once")
    @patch("practice.core.utils.play_utils._load_model_from_config")
...
class TestLoadModelFromConfig:
    ...
    @patch("practice.core.utils.play_utils.load_model")
